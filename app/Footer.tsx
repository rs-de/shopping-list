...
export default function Footer() {
  ...
  return (
    <footer className="flex flex-wrap justify-between bg-slate-2 text-slate-11 text-sm px-4 py-2">
      ...
      <div className="whitespace-nowrap flex gap-x-2 flex-wrap">
        <Link to={"/about"}>{t("about")}</Link>|
        <Link to={"https://www.rushsoft.de/privacy"}>{t("privacy")}</Link>|
        <Link to={"https://www.rushsoft.de/imprint"}>{t("imprint")}</Link>|
        <Link
          to="https://github.com/rs-de/shopping-list"
